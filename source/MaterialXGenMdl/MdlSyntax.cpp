...
// MDL specific built-in types to handle enumeration output
namespace Type
{

TYPEDESC_REGISTER_TYPE(MDL_COORDINATESPACE)
TYPEDESC_REGISTER_TYPE(MDL_ADDRESSMODE)
TYPEDESC_REGISTER_TYPE(MDL_FILTERLOOKUPMODE)
TYPEDESC_REGISTER_TYPE(MDL_FILTERTYPE)
TYPEDESC_REGISTER_TYPE(MDL_DISTRIBUTIONTYPE)
TYPEDESC_REGISTER_TYPE(MDL_SCATTER_MODE)
